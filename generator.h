...
void generateObstacles(sf::Sprite ob[])
{
    ...
    {
        if(i==305)
            {lines[i].spriteX=3; lines[i].sprite=ob[6];} //WANRNING SIGN
        if(i==1175)
        ...
        if(i>0 && i<451 && i%15==0)
           {lines[i].spriteX=4.1; lines[i].sprite=ob[1];} //TREE
        ...
        if(i==251)
            {lines[i].spriteX=-4.5; lines[i].sprite=ob[14];} //CURVE
        if(i==1051)
            {lines[i].spriteX=3.5; lines[i].sprite=ob[14];} 

        if(i==1500)
            {lines[i].spriteX=2; lines[i].sprite=ob[5];} //OBSTACLE
        if(i==2495)
